...
public String msgPseudo(String msgErreurPseudo)
    {
        if (msgErreurPseudo != null && ! msgErreurPseudo.isEmpty()) {
            return msgErreurPseudo;
        }
        return "";
    }
%>
               ...
               <div class="contact_form">
                <div class="form_subtitle">Créer un nouveau compte (* champ obligatoire)</div>
                 <form name="Enregistrement" action="https://localhost:8181/Animo/AnimoServlet">
                    ...
                    <input type="text" class="<%= isEmpty(personne.getNom()) %> " name="nom"  value="<%= personne.getNom() %>" />
                    </div>
                    ...
                    <div class="form_row">
                    <label class="contact"><strong>Pseudo*: <%= session.getAttribute("msgErreurPseudo") %></strong></label>
                    ...
                    <input type="password" class="form_row_null" name="motDePasse"/>
                    </div>
